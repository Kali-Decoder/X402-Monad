...
import { S8004_ADDRESS, S8004_ABI } from '../app/contracts';
import { CreateAgentForm } from '../app/types/agent';
...
export function CreateAgent({ onSuccess }: CreateAgentProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-500 mt-1">
                This endpoint will be used when querying the agent. The Query button will call <code className="text-zinc-400">/api/premium</code> with this endpoint as a parameter.
              </p>
            </div>
